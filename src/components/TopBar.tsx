    ...
    <div className="bg-primary text-primary-foreground text-sm py-2">
      <div className="container mx-auto section-padding flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://www.instagram.com/mgcgroups/" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors" aria-label="Instagram">
          ...
          <a href="https://api.whatsapp.com/send?phone=919770077077" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors" aria-label="WhatsApp">
